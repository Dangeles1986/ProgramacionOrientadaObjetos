...
public class ModificadorPrivate {
    ...
    private void ejemploTres(){
        System.out.println("No se puede acceder a este metodo desde otra clase, es privado");
        /*
        ...
        es por medio de los metodos getter y setter. Al utilizar metodos privados
         */
    }
